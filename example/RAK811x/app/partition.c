...
static uint32_t get_active_partition(partition_index index)
{
    uint32_t key_word;
...
static uint32_t get_passive_partition(partition_index index)
{
    uint32_t key_word;
    uint32_t addr = partition_map[index].part_addr;
...
static void set_active_partition(partition_index index)
{
    uint32_t key_word;
    uint32_t addr = partition_map[index].part_addr;
